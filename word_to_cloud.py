...
def word_cloud(wordlist, pic):  # pic是图片名称
    ...
    wc = WordCloud(width=1600, background_color="white", max_words=50, scale=10, max_font_size=500,
                   random_state=42, font_path=r'/Users/Bloodz/Library/Fonts/SimHei.ttf')
